var gameoverState = {
    create: function() {
        ...
        var scoreLabel = game.add.text(500, game.world.centerY, 'Maior pontuação: ' + game.global.score, { font: '25px Arial', fill: '#ff0000' });
        ...
        var startLabel = game.add.text(500, 500, 'Pressione para cima para recomeçar', { font: '25px Arial', fill: '#ffffff' });
